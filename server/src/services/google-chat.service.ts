...
export class GoogleChatService {
    ...
    sendNotifyWebHookReview(meeting: Meeting, webhookUrl: string) {
        this.sendNotifyWebHook(meeting, webhookUrl);
    }

    sendNotifyWebHookActiveTimeTreking(meeting: Meeting, webhookUrl: string) {
        this.sendNotifyWebHook(meeting, webhookUrl);
    }
